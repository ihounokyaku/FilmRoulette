...
//        do {
//
//            print("adding filter \(title) \(type), \(condition)")
//            try GlobalDataManager.realm.write {
//                if type == .genre {
//
...
//
//                    print("\(self.tagsMayInclude.contains(title)) \(self.tagsMustExclude.contains(title)) \(self.tagsMayInclude.contains(title))")
//                }
//            }
//        } catch let error {
